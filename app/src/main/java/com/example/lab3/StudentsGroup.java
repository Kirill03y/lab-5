...
public class StudentsGroup {
    ...
    private static ArrayList<StudentsGroup> groups = new ArrayList<StudentsGroup>(
            Arrays.asList(
                    new StudentsGroup("К20-3", "Компьютерные науки", 0, true, false),
                    new StudentsGroup("К21-3", "Компьютерные науки", 0, false, true),
                    new StudentsGroup("К21-3м", "Компьютерные науки", 1, true, false)
            )
    );
